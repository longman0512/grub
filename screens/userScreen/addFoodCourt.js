...
export default class addFoodCourt extends Component {
  ...
  componentDidMount(){
    ...
    // if(this.props.navigation.state.params.data.dishs){
    //   this.props.navigation.state.params.data.dishs.map((d, id)=>{
    //     if(d.item_name){
    //       dishTemp.push({
    //         id: d.item_id,
    //         name: d.item_name
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={{marginBottom: 20, borderBottomWidth: 1, borderBottomColor: "#6599D9"}}>
            {/* <TextInput style={styles.input}
                ...
                onChangeText={(v) => { this.setState({ location: v }) }}
          ...
          <View style={{marginBottom: 20, borderBottomWidth: 1, borderBottomColor: "#6599D9"}}>
              {/* <TextInput style={styles.input}
                placeholder='Name'
                onChangeText={(v) => { this.setState({ food_name: v }) }}
                inputStyle={styles.inputText}
