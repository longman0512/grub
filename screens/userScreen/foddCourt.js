  ...
  render() {
    return (
      <View
        style={{flex: 1}}
      >
        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center",height: 70,  position: "relative", }}>
          ...
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center", marginHorizontal: 6, paddingTop: 20, height: "100%" }}>
            <Icon
              name="reload"
              // reverse
              color="#000"
          ...
          </View>
          {
            ...
            style={{ position: "absolute", top: 70, zIndex: 20, width: global.CONSTANT.WIDTH, height: global.CONSTANT.HEIGHT, backgroundColor: "rgba(0, 0, 0, 0.7)"}}
            onPress={()=>{
              console.log("touich")
              this.setState({dropdownView: false})
            }}
          >
            ...
            >
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={{width: "100%", zIndex: 30, flexDirection: "row", justifyContent: "space-between", borderColor: "gray", borderBottomWidth: 1}}
                    activeOpacity={0.5}
                    onPress={()=>{
                      console.log(item)
                      this.setState({dropdownView: false})
                  ...
                  >
                    <Text style={{ padding: 10, width: "70%", backgroundColor: "white",  }}>{item.food_name} </Text>
