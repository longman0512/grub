...
const slides = [
  ...
  //   text:
  //     "Jump on their order and your teammates will pick it up for you and bring it backto the office for free",
  //   image: require("../../assets/grubIntro4.png"),
  //   backgroundColor: "#fff"
  // },
  // {
  //   key: "somethun1",
  //   title: "Be the office hero",
  //   text:
  //     "You'll earn bonus points when you bring back extra points order from teammates - just leave them at youor floor's drop off.",
  //   image: require("../../assets/grubIntro5.png"),
  //   backgroundColor: "#fff"
  // }
];
